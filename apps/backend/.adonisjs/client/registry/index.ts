...
const routes = {
  ...
  'raw_materials.list_all': {
    ...
    tokens: [{"old":"/api/v1/raw-materials/list-all","type":0,"val":"api","end":""},{"old":"/api/v1/raw-materials/list-all","type":0,"val":"v1","end":""},{"old":"/api/v1/raw-materials/list-all","type":0,"val":"raw-materials","end":""},{"old":"/api/v1/raw-materials/list-all","type":0,"val":"list-all","end":""}],
    types: placeholder as Registry['raw_materials.list_all']['types'],
  },
  'raw_materials.seed': {
    methods: ["POST"],
